...
return [
    ...
    'item'     => [
        ...
        'image_index'  => [
            ...
            'description' => sprintf(
                __(
                    "First make <strong>width</strong> directory on <strong>%s</strong> path, and you need upload images by ftp on it and put main image name on this field, for example if you input <strong>header.jpg</strong> on this field images size and name should be : 
        ...
        'manage_register'     => [
            ...
            'description' => _a(
                'Manage register options by user side. If yes, those extra fields will showed on user form : Address and Registration details/requirements'
            ),
            'edit'        => 'checkbox',
            'filter'      => 'number_int',
            'value'       => 1,
